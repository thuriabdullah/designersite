...
//   public List<Servies> getAllServiesByDesigner(String id) {
//
//       Long designer_id=Long.parseLong(id);
//        List<Servies> servies=serviesRepository.findAll();
//       for (Servies temp : servies) {
//           if (temp.getDesigner() != null) {
//               if (temp.getDesigner().getDoctorId() == doct_id) {
//
//
//
//    }
