...
//        return designerServies.getDesignerByType(type);
//    }
//    @GetMapping(("findByDesignType/{designType}"))
//    public List<Designer> findDesignerByDesignType(@PathVariable String designType){
//        return designerServies.findDesignerByDesignType(designType);
//    }
